...
# ax3.plot(neu_Time_I1, neu_I1, label='Strom 1', c='darkblue')
# ax3.plot(neu_Time_I2, neu_I2, label='Strom 2', c='dodgerblue')
...
# ax3.set_ylim([0,max(neu_I1)*1.05])
...
## Output
fig.savefig('Anlaufkurven_Spannung.svg', bbox_inches = 'tight')
fig.savefig('Anlaufkurven_Spannung.png', bbox_inches = 'tight', dpi=500)